...
public class OfferingController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Specialization> getSpecializationById(@PathVariable("id") UUID id) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @PutMapping("/{id}")
    public ResponseEntity<Specialization> updateSpecialization(@PathVariable("id") UUID id, @RequestBody Specialization specialization) {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteSpecialization(@PathVariable("id") UUID id) {
